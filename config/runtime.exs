...
if config_env() != :prod do
  config :evo, EvoWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
end
...
if config_env() == :prod do
  ...
  config :evo, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  port = String.to_integer(System.get_env("PORT") || "4000")
  ssl_keyfile = System.get_env("SSL_KEY_PATH") || "priv/ssl/server.key"
  ssl_certfile = System.get_env("SSL_CERT_PATH") || "priv/ssl/server.crt"
